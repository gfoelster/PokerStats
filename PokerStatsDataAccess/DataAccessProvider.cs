...
namespace PokerStatsDataAccess
{
    public class DataAccessProvider
    {
        ...
        {
            return ctx.Games.Single(g => g.GameID == gameID);
        }
        ...
        {
            return ctx.GameActions.Where(ga => ga.GameID == gameID && ga.GameActionID >= fromPositionInclusive)
                                  .OrderBy(ga => ga.GameActionID)
                                  .ToList();
        }
        ...
        {
            List<int> joinedUsers = ctx.UserSeats.Where(us => us.GameID == game.GameID).Select(us => us.UserID).ToList();
            return joinedUsers;
        }
        ...
        public void PlaceUserOnFreeSeat(Game game, User user, int gameActionID)
        {
            ...
            GameAction action = ctx.GameActions.Single(ga => ga.GameActionID == gameActionID);
        ...
        public void PayBlinds(Game game)
        {
            ...
            List<UserSeat> seats = ctx.UserSeats.Where(us => us.GameID == game.GameID)
                                           .OrderBy(us => us.Seat)
                                           .ToList();
